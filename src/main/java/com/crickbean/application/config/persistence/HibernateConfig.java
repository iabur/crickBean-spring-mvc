package com.crickbean.application.config.persistence;
...
@EnableJpaRepositories("com.crickbean.application.repositories")
    ...
    public SessionFactory createAndGetLocalSessionFactoryBean() {
        if (this.sessionFactory == null) {
            try {
                ...
                configuration.addPackage("com.crickbean.application.model");
                for (Class<?> clazz : (new Reflections("com.crickbean.application.model")).getTypesAnnotatedWith(Entity.class)) {
