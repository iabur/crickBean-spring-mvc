...
<!--/.Navbar -->
                    ...
                    <div class="col-md-8 offset-md-2">
                        ...
                        <div>
                            <div class="jumbotron text-center" id="jumbo">
                                <h1 id="jt-leading">International Cricket Council</h1>
    ...
    <script src="${pageContext.request.contextPath}/bootstrap/main/js/bootstrap.min.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/js/image-card-materialize.js"></script>
</body>
