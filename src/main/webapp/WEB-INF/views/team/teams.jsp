...
<head>
    ...
    <link rel="stylesheet" href="assets/css/image-card-materialize-1.css">
...
<div>
  <div class="container">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="#!" class="black-text d-flex justify-content-end">
                <h5>More <i class="fas fa-angle-double-right"></i></h5>
              </a>
            </div>
          </div>
          <!-- Card Light -->
    ...
    <div id="footer-margin" class="footer-dark">
        <footer>
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-md-3 item">
                        <h3><strong>ICC EVENTS</strong><br></h3>
                        <ul>
                            <li><a href="#">ICC U19 Cricket World Cup</a></li>
                            <li><a href="#">ICC Cricket World Cup</a></li>
                            <li><a href="#"></a></li>
                        </ul>
                    </div>
                    <div class="col-sm-6 col-md-3 item">
                ...
                <p class="copyright"> International Cricket Council© 2020</p>
            </div>
        </footer>
    </div>
    ...
    <script src="assets/js/image-card-materialize.js"></script>
</body>
